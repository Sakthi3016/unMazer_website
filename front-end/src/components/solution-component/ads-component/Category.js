  ...
  return (
    <div className="category_Component">
      <div className="category_head_wrap">
        <div>Many unconventional sources have made</div>
        <div>it possible to measure the immeasurable.</div>
        <div>
          unMazer helps the advertising stems from a wide amount of multi-channel data collection and AI led inferences. Every dollar is used more judiciously!
        </div>
      </div>
