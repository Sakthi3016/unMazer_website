...
import main from "../../../assets/images/solution-assests/media-assests/banner.svg";
import banner from "../../../assets/images/solution-assests/media-assests/banner.png";
          ...
          {mainBannerData.map((item, i) => {
            return (
              <div>
                ...
                <div style={{fontSize:"22px"}}>{item.heading}</div>
                <div class="image" >
