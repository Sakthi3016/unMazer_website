...
const Demo = () => {
  ...
  if(user) {
    return (
        ...
        <p style={{ margin: "auto",textAlign:"center", fontFamily: "poppins", paddingBottom: "2rem", fontSize:"18px" }}>proceed to unMazer platform</p>
        <button type="button" id="platform" class="platform" style={{ margin: "auto",textAlign:"center", fontFamily: "poppins", color:"white", background: "#092685", borderRadius: "5px", fontSize:"18px"}} onClick={platform}>unMazer platform</button>
        <br/>
        <br/>
    ...
    return (
      <div className="Demo_main fixed_header_margintop">
        <Helmet>
          <meta charSet="utf-8" />
          <title>unMazer | Demo - Try our Platform</title>
            ...
            <div className="col-lg-6 col-md-6 col-sm-12 col-12 part1_demo">
              <div style={{ margin: "auto",textAlign:"center"}}>
                ...
                <div className="demo_info_img_bottom">
                  unMazer uses over 300 unique alternative data signals to find
