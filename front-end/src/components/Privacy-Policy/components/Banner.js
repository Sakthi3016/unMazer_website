...
const Banner = () => {
  return (
    <div className="container">
      <div>
        <h1 className="priv_h2">Privacy Policy for Ideth Tech Pvt Ltd</h1>
      </div>
      <div className="priv_com priv_b1">
        At unMazer, accessible from unMazer.ai, one of our main priorities
        is the privacy of our visitors. This Privacy Policy document contains
        types of information that is collected and recorded by unMazer and how
        we use it.
      </div>
      ...
      <div className="priv_com priv_b3">
        ...
        shared and/or collect in unMazer.
        <br />
