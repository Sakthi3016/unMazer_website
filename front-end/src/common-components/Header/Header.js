    ...
    <Accordion  className="slide_container">
      ...
      <AccordionDetails>
        <Typography>
          ...
          <Link onClick={()=>{setShowNav(false)}} to="/insight/Sample"><div className="head_slide_ele">REPORT</div></Link>
          
          <Link onClick={()=>{setShowNav(false)}} to="http://blog.unmazer.ai/"><div className="head_slide_ele">BLOG</div></Link>
    ...
    <div className="row header fixedheader">
      ...
      <div className="col-lg-10 col-md-10 col-sm-10 col-12 header-box-main">
        <div style={{margin:"auto 0"}}>
         ...
         <Link to="/"><span className="compny-name">unMazer</span></Link> 
        </div>
